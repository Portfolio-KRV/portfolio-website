export const translations = {
  en: {
    ...
    projects: {
      ...
      intro: 'These projects represent my exploration of machine learning and data science during my academic journey. While my professional work at FlowPagos involves production systems handling real transactions, these projects allowed me to experiment with different techniques and deepen my understanding of the fundamentals.',
      featuredTitle: 'Live demos',
      featuredSubtitle: 'Interactive end-to-end deployments. Click any card to try the model in your browser — no setup required.',
      othersTitle: 'Studies & experiments',
      othersSubtitle: 'Notebook-driven research with full source available on GitHub.',
      categories: {
        all: 'All',
  ...
  es: {
    ...
    projects: {
      ...
      intro: 'Estos proyectos representan mi exploración del machine learning y ciencia de datos durante mi trayectoria académica. Mientras mi trabajo profesional en FlowPagos involucra sistemas en producción manejando transacciones reales, estos proyectos me permitieron experimentar con diferentes técnicas y profundizar mi entendimiento de los fundamentos.',
      featuredTitle: 'Demos en vivo',
      featuredSubtitle: 'Despliegues interactivos end-to-end. Haz clic en cualquier tarjeta para probar el modelo en tu navegador — sin instalación.',
      othersTitle: 'Estudios y experimentos',
      othersSubtitle: 'Investigación basada en notebooks con código fuente completo disponible en GitHub.',
      categories: {
        all: 'Todos',
        'deep-learning': 'Deep Learning',
