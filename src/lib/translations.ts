export const translations = {
  en: {
    ...
    home: {
      ...
      description: "From building the data warehouse that cut load times by 85% at FlowPagos, to leading an AI roadmap that shipped real-time fraud detection under 300ms, to running the technology strategy as CTO — four years at a payments platform.",
  ...
  es: {
    ...
    home: {
      ...
      description: "De construir el data warehouse que redujo los tiempos de carga en 85% en FlowPagos, a liderar un roadmap de IA que lanzó detección de fraude en tiempo real bajo 300ms, a correr la estrategia tecnológica como CTO — cuatro años en una plataforma de pagos.",
