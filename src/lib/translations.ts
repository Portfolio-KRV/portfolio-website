export const translations = {
  en: {
    ...
    home: {
      ...
      description: "From building the data warehouse that cut load times by 85% at FlowPagos, to leading the AI roadmap (real-time fraud detection under 300ms, a transformer paper at IEEE CAI 2025), to running the technology strategy as CTO — four years at a payments platform.",
  ...
  es: {
    ...
    home: {
      ...
      description: "De construir el data warehouse que redujo los tiempos de carga en 85% en FlowPagos, a liderar el roadmap de IA (detección de fraude en tiempo real bajo 300ms, un paper sobre transformers en IEEE CAI 2025), a correr la estrategia tecnológica como CTO — cuatro años en una plataforma de pagos.",
