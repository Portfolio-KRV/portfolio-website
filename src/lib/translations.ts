export const translations = {
  en: {
    ...
    home: {
      ...
      description: "Currently CTO at FlowPagos, leading 25 people across Software, Infrastructure, and Data & Analytics. Past work includes a data warehouse that cut load times by 85%, real-time fraud detection under 300ms, and transformer research presented at IEEE CAI 2025.",
  ...
  es: {
    ...
    home: {
      ...
      description: "Actualmente CTO en FlowPagos, liderando 25 personas en Software, Infraestructura y Datos y Analítica. Trabajo previo incluye un data warehouse que redujo tiempos de carga en 85%, detección de fraude en tiempo real bajo 300ms, e investigación con transformers presentada en IEEE CAI 2025.",
